...
class IRMapper(Node):
    def __init__(self):
        ...
        self.ir_sub      = self.create_subscription(Range, '/ir_intensity_left', self.ir_callback, qos_profile_sensor_data)
    ...
    def ir_callback(self, msg: Range):
        ...
        try:
            xf = self.tf_buffer.lookup_transform(
                ...
                msg.header.frame_id,  # source frame (e.g. “ir_intensity_left”)
                rclpy.time.Time())
